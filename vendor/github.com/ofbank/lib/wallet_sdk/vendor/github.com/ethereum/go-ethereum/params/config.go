...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		OIPBeeBlock: big.NewInt(0),

		OIPBeeAddress:getBeeAddress(),
	...
	AllProtocolChanges = &ChainConfig{big.NewInt(1337),
		...
		big.NewInt(0),
		big.NewInt(0),
		big.NewInt(math.MaxInt64) /*disabled*/ ,
		new(EthashConfig), nil,
		big.NewInt(0),
		common.StringToAddress("0x00007b007b55343f8ff4f54a12ecae8ef52befaedceeb20a11")}

	TestChainConfig    = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), nil, new(EthashConfig), nil,nil,common.Address{}}
...
func(c *ChainConfig) GetPollenAddress()common.Address{
	return c.OIPBeeAddress

}

func getBeeAddress() common.Address {
	address, _ := hexutil.Decode("0x00007b007b55343f8ff4f54a12ecae8ef52befaedceeb20a11")
